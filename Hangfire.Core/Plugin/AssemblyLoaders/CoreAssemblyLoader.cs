...
namespace Hangfire.Plugin.AssemblyLoaders
{
    /// <summary>
    ...
    internal class CoreAssemblyLoader : AssemblyLoaderBase
    {
        ...
        private static CoreAssemblyLoader _instance;

        public static CoreAssemblyLoader Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new CoreAssemblyLoader();
                }
                return _instance;
            }
        }
